...
export interface EditorialCompareVehicle {
  id: string;
  brand: string;
  model: string;
  variantName: string;
...
interface EditorialCompareViewProps {
  initialVehicles: EditorialCompareVehicle[];
  allCatalogVehicles: {
    id: string;
    brand: string;
    model: string;
...
export function EditorialCompareView({
  initialVehicles,
  allCatalogVehicles,
}: EditorialCompareViewProps) {
  const router = useRouter();
  const { removeCompare, clearCompare } = useCompare();

  const [vehicles, setVehicles] =
    useState<EditorialCompareVehicle[]>(initialVehicles);
  ...
  useEffect(() => {
    if (
      ...
      window.location.search.includes("make=true")
    ) {
  ...
  const handleSlotSelect = (slotIndex: number, vehicleId: string) => {
    ...
    const cleaned = updated
      .map((id, idx) => (id === vehicleId && idx !== slotIndex ? "" : id))
      .filter(Boolean);
    ...
    return [
        ...
        rows: [
          {
            ...
            getValue: (v: EditorialCompareVehicle) =>
              formatPriceRange(v.priceMinLakh, v.priceMaxLakh),
            compareKey: (v: EditorialCompareVehicle) => v.priceMinLakh,
            numeric: true,
            better: "low",
          },
          {
            ...
            getValue: (v: EditorialCompareVehicle) =>
              v.pakAvailability?.isLocallyAssembled
                ? "CKD (Local)"
                : "CBU (Imported)",
            compareKey: (v: EditorialCompareVehicle) =>
          ...
          },
          {
            ...
            getValue: (v: EditorialCompareVehicle) =>
              v.pakAvailability
                ? `${
                    v.pakAvailability.warrantyYears
                  } Years / ${v.pakAvailability.warrantyKm.toLocaleString()} KM`
                : "Standard Warranty",
            compareKey: (v: EditorialCompareVehicle) =>
        ...
        rows: [
          {
            key: "power",
            label: "Horsepower (HP)",
            getValue: (v: EditorialCompareVehicle) => `${v.powerHp} hp`,
            compareKey: (v: EditorialCompareVehicle) => v.powerHp,
            numeric: true,
            better: "high",
          },
          {
            key: "torque",
            label: "Torque (Nm)",
            getValue: (v: EditorialCompareVehicle) => `${v.torqueNm} Nm`,
            compareKey: (v: EditorialCompareVehicle) => v.torqueNm,
            numeric: true,
            better: "high",
          },
          {
            ...
            label: "Top Speed",
            getValue: (v: EditorialCompareVehicle) =>
              v.specification?.topSpeedKmh
                ? `${v.specification.topSpeedKmh} km/h`
                : "180 km/h",
            compareKey: (v: EditorialCompareVehicle) =>
              v.specification?.topSpeedKmh || 180,
            numeric: true,
            better: "high",
          },
          {
            ...
            getValue: (v: EditorialCompareVehicle) =>
              v.specification?.acceleration0to100
                ? `${v.specification.acceleration0to100} s`
                : "N/A",
            compareKey: (v: EditorialCompareVehicle) =>
              v.specification?.acceleration0to100 || 12,
            numeric: true,
            better: "low",
          },
        ],
        ...
        rows: [
          {
            ...
            getValue: (v: EditorialCompareVehicle) => v.engine,
            compareKey: (v: EditorialCompareVehicle) => v.engine,
          },
          {
            key: "displacement",
            label: "Displacement (cc)",
            getValue: (v: EditorialCompareVehicle) =>
              v.specification?.displacementCc
                ? `${v.specification.displacementCc} cc`
                : "N/A (EV/Historical)",
            compareKey: (v: EditorialCompareVehicle) =>
              v.specification?.displacementCc || 0,
            numeric: true,
            better: "high",
          },
          {
            key: "transmission",
            label: "Transmission",
            getValue: (v: EditorialCompareVehicle) => v.transmission,
            compareKey: (v: EditorialCompareVehicle) => v.transmission,
          },
          {
            key: "drive",
            label: "Drivetrain",
        ...
        rows: [
          {
            ...
            getValue: (v: EditorialCompareVehicle) => v.fuelType,
            compareKey: (v: EditorialCompareVehicle) => v.fuelType,
          },
          {
            key: "mileage",
            ...
            compareKey: (v: EditorialCompareVehicle) => v.mileageKmpl || 0,
            numeric: true,
            better: "high",
          },
          {
            ...
            getValue: (v: EditorialCompareVehicle) =>
              v.fuelTankL ? `${v.fuelTankL} L` : "N/A",
            compareKey: (v: EditorialCompareVehicle) => v.fuelTankL || 0,
            numeric: true,
            better: "high",
          },
        ],
        ...
        rows: [
          {
            key: "bodyType",
            label: "Body Type",
            getValue: (v: EditorialCompareVehicle) => v.bodyType,
            compareKey: (v: EditorialCompareVehicle) => v.bodyType,
          },
          {
            key: "seating",
            label: "Seating Capacity",
            getValue: (v: EditorialCompareVehicle) => `${v.seating} Seats`,
            compareKey: (v: EditorialCompareVehicle) => v.seating,
            numeric: true,
            better: "high",
          },
          {
          ...
          },
          {
            ...
            compareKey: (v: EditorialCompareVehicle) => v.bootSpaceL || 0,
            numeric: true,
            better: "high",
          },
          {
      ...
      },
      {
        ...
        rows: [
          {
            key: "airbags",
            label: "Safety Airbags Count",
            getValue: (v: EditorialCompareVehicle) => `${v.airbags} Airbags`,
            compareKey: (v: EditorialCompareVehicle) => v.airbags,
            numeric: true,
            better: "high",
          },
          {
            ...
            getValue: (v: EditorialCompareVehicle) =>
              v.features.length > 0 ? `${v.features.length} Features Documented` : "Standard Equipment",
            compareKey: (v: EditorialCompareVehicle) => v.features.length,
            numeric: true,
            better: "high",
          },
        ],
  ...
  const getBestIndex = (row: any) => {
    ...
    if (vals.every((x) => x === vals[0])) return -1;
  ...
  const presets = [
    {
      ...
      ids: "toy-corolla-e170-2014-altis-grande,hon-civic-fe-15-oriel-2022,hyu-elantra",
    },
    {
    ...
    },
    {
      ...
      ids: "suz-alto,suz-swift,suz-cultus-mk2-2000",
    },
    {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16 bg-[#0E0F11]">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-[#2A2C30] mb-8">
        <div>
          ...
          <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#C9A227]">
            ...
            <span>SIDE-BY-SIDE AUTOMOTIVE INTELLIGENCE</span>
          </div>
          <h1 className="font-display text-3xl sm:text-4xl font-bold text-[#EDEBE6] tracking-tight">
            Compare Vehicles
          </h1>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 sm:gap-4">
          ...
          <label className="flex items-center gap-2 cursor-pointer bg-[#17181B] border border-[#2A2C30] px-3.5 py-2 rounded-sm text-xs font-mono text-[#EDEBE6] hover:border-[#3E8A6C] transition-colors select-none">
            <input
              type="checkbox"
          ...
          {vehicles.length > 0 && (
            <Button
              ...
              className="text-xs font-mono uppercase text-[#B24A3C] hover:text-[#E37A6D]"
            >
              CLEAR ALL
            </Button>
          )}
      ...
      {/* Preset Buttons Bar */}
      <div className="mb-10 p-4 rounded-sm border border-[#2A2C30] bg-[#141518] space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          {presets.map((preset) => (
            <button
              ...
              className="px-3 py-1.5 rounded-sm bg-[#1F2023] border border-[#2A2C30] hover:border-[#3E8A6C] text-xs font-mono font-medium text-[#EDEBE6] transition-colors"
            >
              {preset.label}
            </button>
          ))}
      ...
      {/* Comparison Table */}
      {vehicles.length === 0 ? (
        <div className="rounded-sm border border-[#2A2C30] bg-[#17181B] p-12 text-center space-y-5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm font-mono text-[#9A9994] max-w-lg mx-auto">
              Make a custom side-by-side comparison across any 2 to 4 Pakistani
              vehicles, or choose one of our benchmark presets below.
            </p>
          </div>
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            ...
            <Button
              ...
              onClick={() =>
                router.push(
                  "/compare?ids=toy-corolla-e170-2014-altis-grande,hon-civic-fe-15-oriel-2022,hyu-elantra"
                )
              }
        ...
        <div className="space-y-6">
          {/* Editorial VS Banner (Phase 17 hierarchy requirement) */}
          {vehicles.length >= 2 && (
            <div className="p-5 rounded-sm border border-[#2A2C30] bg-[#141518] flex flex-wrap items-center justify-center gap-3 sm:gap-4 font-display text-xl sm:text-2xl font-bold text-[#EDEBE6]">
              {vehicles.map((v, i) => (
                <React.Fragment key={v.id}>
                  {i > 0 && (
                    <span className="font-mono text-xs font-bold text-[#0E0F11] bg-[#C9A227] px-2.5 py-1 rounded-sm tracking-widest">
                      VS
                    </span>
                  )}
                  <Link
            ...
            <thead>
              <tr className="border-b border-[#2A2C30]">
                <th className="w-48 p-4 align-top bg-[#141518] border-r border-[#2A2C30]">
                  ...
                  <span className="text-xs font-mono text-[#9A9994] font-normal block mt-1">
                ...
                {vehicles.length < 4 && (
                  <th className="w-64 p-6 align-middle bg-[#141518]/50 border-r border-[#2A2C30] text-center">
                    <div className="space-y-3">
                      ...
                      <span className="text-sm font-mono font-semibold text-[#EDEBE6] block">
                ...
                <React.Fragment key={section.section}>
                  ...
                  <tr className="bg-[#1F2023]/60">
                    <td
                      ...
                      className="py-2.5 px-4 font-mono text-xs font-bold uppercase tracking-widest text-[#C9A227]"
                    >
                      {section.section}
                    </td>
                  </tr>
                  ...
                  {section.rows.map((row) => {
                    ...
                    return (
                      ...
                      >
                        <td className="py-3 px-4 text-xs font-mono font-semibold text-[#9A9994] bg-[#141518] border-r border-[#2A2C30]">
                          {row.label}
                        </td>
                        ...
                        {vehicles.map((v, idx) => {
                          ...
                          return (
                            <td
                              key={v.id}
                              className={`py-3 px-4 text-sm font-mono border-r border-[#2A2C30] ${
                                isBest
                                  ? "bg-[#2F6B54]/15 text-[#4EBA8E] font-bold"
                                  : "text-[#EDEBE6]"
                              }`}
                            >
                              <div className="flex items-center justify-between">
                                ...
                                {isBest && (
                                  <Badge
                                    variant="new"
                                    className="text-[10px] py-0 px-1.5 ml-2 font-mono"
                                  >
                                    BEST VALUE
                                  </Badge>
                                )}
      ...
      {/* Modal for Adding Single Vehicle to Compare */}
      {addModalIndex !== null && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-lg rounded-sm border border-[#2A2C30] bg-[#17181B] p-6 space-y-4 shadow-elevated">
            ...
            <input
              ...
              className="w-full h-10 rounded-sm border border-[#2A2C30] bg-[#0E0F11] px-3 text-sm text-[#EDEBE6] placeholder:text-[#616266] focus:border-[#2F6B54] focus:outline-none font-body"
              autoFocus
            />
            ...
            <div className="max-h-72 overflow-y-auto divide-y divide-[#2A2C30]">
              {availableToAdd
                ...
                .map((cv) => (
                  ...
                  >
                    <div>
                      <span className="font-semibold text-[#EDEBE6] font-display">
                        {cv.brand} {cv.model}
                      </span>
                      <span className="text-xs font-mono text-[#9A9994] block">
                        {cv.variantName}
                      </span>
                    </div>
                    <Button
          ...
          <div className="w-full max-w-4xl rounded-sm border border-[#2A2C30] bg-[#141518] p-6 sm:p-8 space-y-6 shadow-elevated animate-in fade-in zoom-in-95 duration-200 my-auto">
            ...
            <div className="flex items-start justify-between border-b border-[#2A2C30] pb-4">
              <div>
                ...
                <h3 className="font-display font-bold text-2xl text-[#8C8B87]">
                  Make Comparison
                </h3>
              ...
              <div className="flex flex-wrap gap-2">
                {presets.map((preset) => (
                  <button
                    ...
                    className="px-2.5 py-1 rounded-sm bg-[#FFFFFF] dark:bg-[#1F2023] border border-[#D8D4CB] dark:border-[#2A2C30] hover:border-[#1F4D3D] dark:hover:border-[#3E8A6C] text-xs font-mono font-medium text-[#17181B] dark:text-[#EDEBE6] transition-colors shadow-subtle"
                  >
                    {preset.label}
                  </button>
                ))}
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-sm border text-xs font-mono transition-colors ${
                          isAlreadySelected
                            ...
                            : "bg-[#1F2023] border-[#2A2C30] hover:border-[#3E8A6C] text-[#8C8B87]"
                        }`}
                      >
                        + {cv.brand} {cv.model}
                      </button>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-[#2A2C30] pt-4">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
                ...
                <Button
                  ...
                  className="font-mono text-xs uppercase tracking-wider gap-2 px-6 bg-[#2F6B54] hover:bg-[#2F6B54] text-[#EDEBE6]"
                >
                  <Scale className="h-4 w-4" />
                  <span>
